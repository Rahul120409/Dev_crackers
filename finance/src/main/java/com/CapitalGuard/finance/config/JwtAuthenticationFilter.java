...
import com.CapitalGuard.finance.service.JwtTokenService;
...
/**
 * Filter that intercepts incoming HTTP requests, validates JWT tokens from the Authorization header,
