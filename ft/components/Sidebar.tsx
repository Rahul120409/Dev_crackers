...
export const Sidebar: React.FC<SidebarProps> = ({ currentTab, onSelectTab }) => {
  ...
  return (
    ...
    >
      ...
      <div>
        <div
          className={`h-16 flex items-center border-b border-[#0077b6]/20 dark:border-slate-800/80 transition-colors ${isOpen ? 'px-4 justify-between' : 'px-0 justify-center'
            }`}
        >
          <div
            ...
            {menuItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center rounded-xl text-xs font-bold transition-all cursor-pointer group relative ${isOpen ? 'justify-between px-3 py-2.5' : 'justify-center p-2.5'
                    } ${isActive
